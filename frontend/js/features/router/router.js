...
// 最終更新日: 2026/08/27
// 作成者: 林健太
// 概要: ページ遷移とURLルーティングを管理するモジュール
// ===================================================

// URL 操作ユーティリティ。
// SPA用のページ遷移は廃止し、window.location.href による画面遷移に統一する。

import { render as renderTaskList } from "../pages/task_list.js?v=20260826-4";
...
import { render as renderLogin } from "../pages/login.js?v=20260826-1";
