...
class TaskRepository:
    ...
    @staticmethod
    def update_task(task_id: int, title: str, description: str | None = None, subtasks: list | None = None, deadline: str | None = None, priority: str = 'medium'):
